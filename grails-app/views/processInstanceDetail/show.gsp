            ...
            <div class="span12">
                ...
                <div class="page-header">
                    <h1>
                        ...
                        <g:if test="${processInstanceDetailInstance?.parentProcess}">
                            <g:link action="show" id="${processInstanceDetailInstance?.parentProcess}" class="btn btn-small"> <i class="icon-arrow-up"></i> </g:link>
                        </g:if>
                    </h1>
                </div>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><g:message code="activity.duration.label" default=""/></th>
                            </tr>
                        </thead>
                        <tbody>
                        <g:each in="${processInstanceDetailInstance.activities}" var="activityInstance">
                            <tr>
                                ...
                                <td class="link">
                                    ...
                                    <g:if test="${activityInstance?.subProcess}">
                                        <g:link action="show" id="${activityInstance.subProcess}" class="btn btn-small">Show &raquo;</g:link>
                                    </g:if>
                                </td>
